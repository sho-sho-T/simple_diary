 ...
 */
export function EmotionBadge({ emotionId, showName = false, className }: EmotionBadgeProps) {
  ...
  return (
    <div className={cn("flex items-center gap-1.5 rounded-full bg-muted px-2 py-1", className)}>
