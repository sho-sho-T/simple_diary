...
import { DiaryCard } from "@/components/features/diary/diary-card";
...
const mockEntry: DiaryEntry = {
  ...
  content: "今日は素晴らしい一日でした。朝早く起きて、公園でジョギングをしました。その後、家族と朝食を食べて、仕事に行きました。仕事では新しいプロジェクトの提案が承認されて、とても嬉しかったです。夕方は友人と食事に行き、楽しい時間を過ごしました。",
  contentMarkdown: "# 今日の日記\n\n今日は素晴らしい一日でした。朝早く起きて、公園でジョギングをしました。\n\nその後、家族と朝食を食べて、仕事に行きました。仕事では**新しいプロジェクトの提案が承認**されて、とても嬉しかったです。\n\n夕方は友人と食事に行き、楽しい時間を過ごしました。",
  emotionStampId: 1,
